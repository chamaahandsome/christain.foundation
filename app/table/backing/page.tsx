...
import { myBacked } from "@/lib/table-queries";

export const dynamic = "force-dynamic";
export const metadata = { title: "You're backing" };

// The supporter's view: every campaign stood behind, with your own pledge
// and how the work is going.
export default async function BackingRoom() {
  const { userId } = await auth();
  if (!userId) redirect("/signin?redirect_url=/table/backing");
  const pledges = await myBacked(userId);
  ...
  return (
    <div className="py-8">
      ...
      <h1 className="mt-2 text-2xl font-semibold">You&apos;re backing</h1>
